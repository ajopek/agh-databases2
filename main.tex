...
\subsection{}
wycieczki\_osoby\_potwierdzone (kraj,data, nazwa\_wycieczki, imie,
nazwisko,status\_rezerwacji)
...
\lstinputlisting[firstline=26, lastline=32]{sql/lab1/widoki.sql}
\subsection{}
wycieczki\_miejsca(kraj,data, nazwa\_wycieczki,liczba\_miejsc, liczba\_wolnych\_miejsc)
\lstinputlisting[firstline=35, lastline=44]{sql/lab1/widoki.sql}
\subsection{}
dostępne\_wyciezki(kraj,data, nazwa\_wycieczki,liczba\_miejsc, liczba\_wolnych\_miejsc)
\lstinputlisting[firstline=55, lastline=63]{sql/lab1/widoki.sql}
\subsection{}
...
\lstinputlisting[firstline=47, lastline=52]{sql/lab1/widoki.sql}
